            ...
            children: [
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [
                    _buildListaHorasExtras(provider.horasExtrasFiltradas),
                    _buildListaHorasExtras(provider.horasExtrasFiltradas.where((h) => h.esFuturo).toList()),
                    _buildListaHorasExtras(provider.horasExtrasFiltradas.where((h) => h.esHoy).toList()),
                    _buildListaHorasExtras(provider.horasExtrasFiltradas.where((h) => h.esPasado).toList()),
                  ],
                ),
              ),
            ],
