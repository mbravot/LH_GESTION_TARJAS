...
class AprobacionTarjasEditarScreen extends StatefulWidget {
  final Tarja tarja;

  const AprobacionTarjasEditarScreen({
    super.key,
    required this.tarja,
  });

  @override
  State<AprobacionTarjasEditarScreen> createState() => _AprobacionTarjasEditarScreenState();
}

class _AprobacionTarjasEditarScreenState extends State<AprobacionTarjasEditarScreen> {
                          ...
                          Expanded(
                            child: _editLabor
                              ? (_isLoadingLabores
                                  ...
                                  : _errorLabores != null
                                    ? Text('Error:  [0m_errorLabores', style: const TextStyle(color: Colors.red))
