...
class BonoEspecialCrearScreen extends StatefulWidget {
  ...
  @override
  State<BonoEspecialCrearScreen> createState() => _BonoEspecialCrearScreenState();
}

class _BonoEspecialCrearScreenState extends State<BonoEspecialCrearScreen> {
  ...
  Future<void> _guardarBonoEspecial() async {
    ...
    try {
      ...
      final resultado = await provider.crearBonoEspecial(datos);

      if (resultado) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Bono especial creado exitosamente'),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Error al crear bono especial: $e'),
            backgroundColor: Colors.red,
          ),
        );
      }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Registre un nuevo bono especial por horas sobrantes',
                  style: TextStyle(
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton(
            onPressed: _isLoading ? null : _guardarBonoEspecial,
